...
var newObject = {
  ...
  third_property: function() {
    return alert("it works!!");
  },
  fourth_property: 2,
  fifth_property: {
    first_child_property: 'another string',
    second_child_property: {
      first_child_child_property: 'deep'
    }
  }
}
...
function addStudent() {
  ...
  newObject.third_property();
  //console.log(newObject.fifth_property.second_child_property.first_child_child_property);
